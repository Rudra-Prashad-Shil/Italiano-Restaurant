...
const Navbar = () => {
    ...
    const listItems = (
        <>
            <li><a href="#" className="hover:text-amber-400 md:px-6">Home</a></li>
            <li><a href="#" className="hover:text-amber-400 md:px-6">About Us</a></li>
            <li className="relative group">
                <a href="#" className="hover:text-amber-400 md:px-6 cursor-pointer">Pages</a>
                <ul className="absolute left-0 top-full min-w-[10rem] bg-white text-black py-2 rounded shadow-lg opacity-0 group-hover:opacity-100 group-hover:visible transition-all duration-500 z-20">
            ...
            <li className="relative group">
                <a href="#" className="hover:text-amber-400 md:px-6 cursor-pointer">Blog</a>
                <ul className="absolute left-0 top-full min-w-[10rem] bg-white text-black py-2 rounded shadow-lg opacity-0 group-hover:opacity-100 group-hover:visible transition-all duration-500 z-20">
            ...
            <li><a href="#" className="hover:text-amber-400 md:px-6">Contact Us</a></li>
        </>
    );
